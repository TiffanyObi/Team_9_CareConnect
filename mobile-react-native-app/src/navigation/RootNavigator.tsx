...
const styles = StyleSheet.create({ iconTarget: { width: 48, height: 48, borderRadius: 14, alignItems: 'center', justifyContent: 'center' }, selectedIcon: { backgroundColor: '#245FCB' }, loading: { flex: 1, alignItems: 'center', justifyContent: 'center', gap: 16, padding: 24, backgroundColor: '#F5F8FC' }, loadingText: { color: '#10233F', fontSize: 18 } });
