# SWEN 661 Week 4 - Flutter Implementation and Testing

Week 4 continues Team 9's existing CareConnect Safeview Flutter application in `mobile-flutter-app/`. The goal is a functional, navigable, accessible, and meaningfully tested application with 7-10 core screens and at least 60% line coverage.

## Start here

1. Read `PROJECT_CONTEXT.md` for the verified baseline.
2. Review `ACCEPTANCE_CRITERIA.md` and `RISK_REGISTER.md` before coding.
3. Select one incomplete phase from `IMPLEMENTATION_PLAN.md`.
4. Make the smallest coherent change and add its focused tests.
